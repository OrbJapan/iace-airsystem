...
// import { basicAuth } from 'hono/basic-auth' // 開発中は一時的に無効化
import { renderer } from './renderer'

const app = new Hono()

// Basic Authentication Middleware (開発中は一時的に無効化)
// app.use('*', basicAuth({
//   username: 'admin',
//   password: 'demo2026'
// }))
        ...
        <div class="container mx-auto px-4 py-4">
          <div class="flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-6">
              <a href="/" onclick="showHomePage(); return false;" class="hover:text-blue-200 transition">
